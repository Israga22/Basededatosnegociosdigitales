...
# Un Store Procedure (procedimiento almacenado) es un conjunto de instrucciones SQL que se guardan y ejecutan en el servidor de bases de datos. Los procedimientos almacenados permiten encapsular lógicas complejas de bases de datos, que pueden ser reutilizadas y ejecutadas varias veces sin necesidad de escribir el código SQL repetidamente.
...
-- Ejecuci�n de un store procedure con parametros en diferente posici�n
exec spu_informe_ventas_clientes @fechaFinal = '1997-01-01', 
                                 @nombre = 'Berglunds snabbk�p', 
								 @fechaInicial = '1996-07-04';

-- Ejecuci�n de un store procedure con parametros de entrada con un 
