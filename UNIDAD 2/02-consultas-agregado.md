# 02-consultas-agregado


# Este código SQL utiliza funciones de agregación como SUM, AVG, COUNT, MIN y MAX para obtener métricas clave sobre clientes, productos, pedidos y empleados en la base de datos Northwind. También agrupa datos con GROUP BY y filtra resultados con HAVING, permitiendo obtener estadísticas como total de ventas, productos por categoría y pedidos por empleado.
